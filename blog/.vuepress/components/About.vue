    ...
    <div class="profile">
      <div class="profile__content">
        ...
        <div class="profile__info col-md-8">
          ...
          <div class="bio-info">
            Qi Feng 是 <del>地球模拟器区域管理员（签证到期）</del>, 目前停留在一个名不见经传的小村落里，
            为村民解决家常理短，顺便疏通村口年久失修的下水道, 并对学习
            <a href="https://www.zhihu.com/question/391699603/answer/1279504050" target="_blank">
              瑜伽
            </a>保留着极高的热情.
              学时随师傅当过四年魔术艺人，但还未出师便稀里糊涂的上了路, 
            <a href="https://www.bilibili.com/video/av85403425/">
              熬过毒瘴迷泽
            </a>
            , 现终日与蟒蛇相伴，然内心愈发想做只愉快的土拨鼠
            <a href="https://github.com/Alikhll/golang-developer-roadmap" target="_blank">
              挥舞魔法棒
            </a>.<br />
            热爱在窗口和苹果之外的理想园中探索，爱折腾家具让自己用的更舒服，偶尔也会画画，一直希望好心人
            给我邮寄一张名字叫3090的画笔，让我可以舒展一下神经 థ౪థ.<br />
            以上, 保留对生活热爱的态度，<del> 等待签证恢复 </del>
          </div>
